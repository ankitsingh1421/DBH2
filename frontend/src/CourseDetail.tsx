...
//         navigate(`/course/${courseId}`); // Navigate to the clicked course's detail page
//     };
...
//                             onClick={() =>
//                                 handleWatchClick(
//                                     course.chapters[0].videos[0].url,
//                                     course.chapters[0].id
//                                 )
//                             }
//                         >
...
//                         </button>
//                     )}
//                     <button className="bg-gray-700 text-white py-3 px-6 rounded-lg shadow-md hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-500 font-medium transition">
//                         Watch Later
//                     </button>
//                 </div>
//             </div>
...
// import { SignedOut, SignInButton, useUser } from '@clerk/clerk-react';
// import ReviewComponent from './components/review/ReviewComponent';
// import Morecourses from './components/more/Morecourses'; // Import the new component
...
//     // Handle redirect to other course details
...
const CourseDetail: React.FC<CourseDetailProps> = ({ onWatchClick }) => {
    ...
    const handleCourseRedirect = (courseId: string) => {
        ...
        }, 1000); // 1 seconds delay for loading
    };
                    ...
                    {isSignedIn ? (
                        buy ? (
                            ...
                            <button
                                ...
                                onClick={() => {
                                    toast.info("course purchase coming soon    ");
                                }}
                            >
                                Enroll Course
                            </button>
